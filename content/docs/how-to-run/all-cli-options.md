...
--storage-netease-bucket value        NOS bucket to store charts for Netease Cloud storage backend [$STORAGE_NETEASE_BUCKET]
...
--storage-netease-endpoint value      NOS endpoint [$STORAGE_NETEASE_ENDPOINT]
...
--storage-netease-prefix value        prefix to store charts for --storage-netease-cloud-bucket [$STORAGE_NETEASE_PREFIX]
